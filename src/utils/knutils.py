...
def get_knimeVis_category():
    """
    Returns the Image Processing category for KNIME extension nodes.
    
    Returns:
        knext.Category: The category object for Image Processing nodes
    """
    return knext.category(
